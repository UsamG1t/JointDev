...
from server import Monster
from client import MUDcmd
from common import steps, addmon_errors, custom_monster
...
default died''',
    ...
    #     with open("test_mocker_errors.mood") as file:
    #         scr = MUDcmd(self.mocker, stdin=file)
    #         scr.prompt = ''
    #         scr.use_rawinput = False
    #         scr.cmdloop()
    ...
    #             'Invalid arguments (value of coord x)',
    #             'Invalid arguments (type of hp)'
    #         ])
    #     res = []
